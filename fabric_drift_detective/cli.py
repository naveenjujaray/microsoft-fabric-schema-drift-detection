...
from fabric_drift_detective.backends.base import Layer, SchemaBackend
from fabric_drift_detective.config import load_config, parse_watch_config
from fabric_drift_detective.git_handler import GitHandler
from fabric_drift_detective.lineage import annotate_downstream
from fabric_drift_detective.lineage_manifest import load_lineage_manifest
from fabric_drift_detective.llm_reasoner import make_reasoner
from fabric_drift_detective.medallion import build_lineage_graph
from fabric_drift_detective.notifications import DriftAlert, build_dispatcher
from fabric_drift_detective.schema_diff import DriftRecord, DriftType, diff_all
from fabric_drift_detective.schema_store import BaselineError, SchemaStore
from fabric_drift_detective.workspace import load_registry
...
def run_once(
    ...
    for analysis in impact.get("analyses", []):
        ...
        if idx is not None and 0 <= idx < len(drifts) and sev:
            ...
            from fabric_drift_detective.schema_diff import Severity
...
def run_agent_cli(
    ...
    from fabric_drift_detective.agents import AGENT_SPECS, ToolContext, run_agent
...
def list_agents_cli() -> int:
    ...
    from fabric_drift_detective.agents import AGENT_SPECS
